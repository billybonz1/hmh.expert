...
function userOnClick(user){
    ...
    window.history.pushState({"html":"messages","pageTitle":"Сообщения"},"", "/profile/messages/user" + userID);
...
if(document.querySelector(".tcp-chat-messages")){
    var simpleBarGroup = new SimpleBar(document.querySelector(".tcp-chat-messages"));
