...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'min' => 'Пароль должен быть как минимум :min символов.',
        ...
        'captcha' => [
            'captcha' => 'Капча заполнена неправильно!'
        ],
        'slug' => [
            'unique' => 'Запись с таким слагом уже существует'
        ]
    ],
