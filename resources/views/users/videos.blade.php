        		    ...
        		    <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            			...
            			<div class="ui-block video-item">
            				<div class="video-player">
            					...
            					<a data-time="{!! $wallvideo->timeElapsedString() !!}" data-desc="{{ $wallvideo->desc }}" data-name="{{ $wallvideo->name }}" href="/uploads/videos/{{ $user->nickname }}/{{ $wallvideo->file_name }}" class="play-video">
