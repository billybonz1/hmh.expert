								...
								<div class="ui-block">
									...
									<article class="hentry post video">
											...
											<div class="post__author author vcard inline-items">
												<a href="{{ route('users_wall', $wallpost->author->nickname) }}">
													<img src="{{ $wallpost->author->avatar() }}" alt="author">
												</a>
												<div class="author-date">
													<a class="h6 post__author-name fn" href="{{ route('users_wall', $wallpost->author->nickname) }}">{{ $wallpost->author->namef() }}</a>
													<div class="post__date">
														<time class="published" datetime="{{ $wallpost->created_at }}"></time>
													</div>
												</div>
											...
											<div class="post-additional-info inline-items">
												...
												<div class="comments-shared">
													<a href="#" class="post-add-icon inline-items">
														...
														<span>{{ count($wallpost->approvedComments) }}</span>
													</a>
